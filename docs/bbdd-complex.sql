...
-- 		CONSTRAINT `userProject_ibfk_1` FOREIGN KEY (`idUser`) REFERENCES `user` (`id`),
-- 		CONSTRAINT `userProject_ibfk_2` FOREIGN KEY (`idProject`) REFERENCES `project` (`id`)
-- 	);
-- CREATE TABLE
...
-- 		CONSTRAINT `project_ibfk_1` FOREIGN KEY (`idWorkspace`) REFERENCES `workspace` (`id`)
-- 	);
