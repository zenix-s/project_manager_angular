...
CREATE DATABASE IF NOT EXISTS `tfgsff_db` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci;
...
--
-- Volcado de datos para la tabla `taskCategory`
--
...
--
-- Volcado de datos para la tabla `userWorkspace`
--
